...
ComboBox {
    ...
    property alias iconString: indicator.text;
    ...
    delegate: ItemDelegate {
        ...
        contentItem: Text {
            leftPadding: control.mirrored ?
                             (control.indicator ? control.indicator.width : 0) + control.spacing
                                : 0
            ...
            color: delegate.highlighted ?
                       attr.fontColorSelected
                     : (delegate.hovered ? attr.fontColorHovered : attr.fontColor);
        ...
        background: Rectangle {
            color: delegate.highlighted ?
                       attr.color
                     : (delegate.hovered ? attr.colorHovered : attr.backgroundColor);
    ...
    contentItem: Text {
        leftPadding: control.mirrored && control.indicator ?
                         control.indicator.width + control.spacing
                       : 0
        rightPadding: !control.mirrored && control.indicator ?
                          control.indicator.width + control.spacing
                        : 0
